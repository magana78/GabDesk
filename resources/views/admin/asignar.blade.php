{{-- resources/views/admin/tickets/asignar.blade.php --}}
<x-app-layout>
    <x-slot name="header">
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg p-6">
                <!-- Asegúrate de que esta línea usa la ruta 'admin.tickets.asignar.post' -->
                <form action="{{ route('admin.tickets.asignar.post', $ticket->id_ticket) }}" method="POST">
                    @csrf
